...
import { numberWithCommas, useLivePrice } from "@strata-foundation/marketplace-ui";

export const BlackBox = ({ children, ...other }) => {
  return (
    <Box
      p={4}
      rounded="lg"
...
export const BigText = ({ children, ...other }) => {
  return (
